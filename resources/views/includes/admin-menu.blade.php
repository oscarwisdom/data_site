<section id="menu">
    ...
    <nav class="items">
        ...
        <li><a href="{{ url('admin/api_manegement') }}"><img src="icons/form.svg" alt="" class="icons">API Management</a></li>
        <li><a href="{{ url('admin/transactions') }}"><img src="icons/credit-card.svg" alt="" class="icons">Transactions</a></li>
